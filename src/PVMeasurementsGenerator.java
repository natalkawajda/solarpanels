...
public class PVMeasurementsGenerator extends Thread
{
...
//      "2023-05-31 12:05:30", "2023-05-31 13:05:30", "2023-05-31 14:05:30", "2023-05-31 15:05:30", "2023-06-01 12:05:30", "2023-06-01 13:05:30", "2023-06-01 14:05:30", "2023-06-01 15:05:30"};
  ...
  public PVMeasurementsGenerator(DatabaseConnector connection){
  ...
  public void run()
  {
    while (true)
    {
      ...
      for (int j = 1; j < 93; j++)
      {
        ...
        int solar_flux = solar_fluxes[(int) Math.floor(Math.random() * solar_fluxes.length)];
        double p_out = voltage * current;
        double efficiency = p_out / power_ins[(int) Math.floor(Math.random() * power_ins.length)];
        PVPanels pvPanels = new PVPanels(date, id, voltage, current, solar_flux,
            p_out, efficiency);
        connection.generatePVMeasurements(pvPanels);
      }
      try
      {
